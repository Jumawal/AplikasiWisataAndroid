...
public class PantaiCemara extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantai_cemara);
        this.setTitle("Pantai Cemara");
        ...
        String url = "http://192.168.43.141/wisata/cemara.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PantaiCemara.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(PantaiCemara.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_cemaraEmail,Email);
                params.put(konfigurasi.KEY_EMP_cemaraKomentar,coment);
                params.put(konfigurasi.KEY_EMP_cemaraRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_PANTAICEMARA, params);
                return res;
            }
        }

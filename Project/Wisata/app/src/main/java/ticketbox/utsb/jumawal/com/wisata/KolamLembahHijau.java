...
public class KolamLembahHijau extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kolam_lembah_hijau);
        this.setTitle("Kolam Renang Lembah Hijau");
        ...
        String url = "http://192.168.43.141/wisata/lembahhijau.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(KolamLembahHijau.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(KolamLembahHijau.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_lembahhijauEmail,Email);
                params.put(konfigurasi.KEY_EMP_lembahhijauKomentar,coment);
                params.put(konfigurasi.KEY_EMP_lembahhijauRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_KOLAMRENANGLEMBAHHIJAU, params);
                return res;
            }
        }

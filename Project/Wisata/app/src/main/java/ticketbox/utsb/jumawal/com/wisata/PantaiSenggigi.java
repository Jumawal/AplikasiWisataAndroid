...
public class PantaiSenggigi extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantai_senggigi);
        this.setTitle("Pantai Senggigi");
        ...
        String url = "http://192.168.43.141/wisata/senggigi.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PantaiSenggigi.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(PantaiSenggigi.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_senggigiEmail,Email);
                params.put(konfigurasi.KEY_EMP_senggigiKomentar,coment);
                params.put(konfigurasi.KEY_EMP_senggigiRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_PANTAISENGGIGI, params);
                return res;
            }
        }

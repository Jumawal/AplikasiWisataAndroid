...
public class AirTerjunTiuTeja extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_terjun_tiu_teja);
        this.setTitle("Air Terjun Tiu Teja ");
        ...
        String url = "http://192.168.43.141/wisata/tiuteja.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AirTerjunTiuTeja.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AirTerjunTiuTeja.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_tiutejaEmail,Email);
                params.put(konfigurasi.KEY_EMP_tiutejaKomentar,coment);
                params.put(konfigurasi.KEY_EMP_tiutejaRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_AIRTERJUNTIUTEJA, params);
                return res;
            }
        }

...
public class Kolamduyung extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kolamduyung);
        this.setTitle("Kolam Renang Putri Duyung");
        ...
        String url = "http://192.168.43.141/wisata/putriduyung.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Kolamduyung.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Kolamduyung.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_putriduyungEmail,Email);
                params.put(konfigurasi.KEY_EMP_putriduyungKomentar,coment);
                params.put(konfigurasi.KEY_EMP_putriduyungRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_KOLAMRENANGPUTRIDUYUNG, params);
                return res;
            }
        }

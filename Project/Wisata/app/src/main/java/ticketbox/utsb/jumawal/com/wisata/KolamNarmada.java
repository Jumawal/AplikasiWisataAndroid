...
public class KolamNarmada extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kolam_narmada);
        this.setTitle("Kolam Renang Narmada");
        ...
        String url = "http://192.168.43.141/wisata/narmada.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(KolamNarmada.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(KolamNarmada.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_narmadaEmail,Email);
                params.put(konfigurasi.KEY_EMP_narmadaKomentar,coment);
                params.put(konfigurasi.KEY_EMP_narmadaRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_KOLAMRENANGNARMADA, params);
                return res;
            }
        }

...
public class AirTerjunOtakKokoh extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_terjun_otak_kokoh);
        this.setTitle("Air Terjun Otak Kokoh ");
        ...
        String url = "http://192.168.43.141/wisata/otakkokoh.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AirTerjunOtakKokoh.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AirTerjunOtakKokoh.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_otakkokohEmail,Email);
                params.put(konfigurasi.KEY_EMP_otakkokohKomentar,coment);
                params.put(konfigurasi.KEY_EMP_otakkokohRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_AIRTERJUNOTAKKOKOH, params);
                return res;
            }
        }

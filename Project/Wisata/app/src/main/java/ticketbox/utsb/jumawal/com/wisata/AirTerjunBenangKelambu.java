...
public class AirTerjunBenangKelambu extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_terjun_benang_kelambu);
        this.setTitle("Air Terjun Benang Kelambu ");
        ...
        String url = "http://192.168.43.141/wisata/benangkelambu.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AirTerjunBenangKelambu.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AirTerjunBenangKelambu.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_benangkelambuEmail,Email);
                params.put(konfigurasi.KEY_EMP_benangkelambuKomentar,coment);
                params.put(konfigurasi.KEY_EMP_benangkelambuRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_AIRTERJUNBENANGKELAMBU, params);
                return res;
            }
        }

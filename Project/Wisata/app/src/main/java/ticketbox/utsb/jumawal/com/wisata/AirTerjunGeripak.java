...
public class AirTerjunGeripak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_terjun_geripak);
        this.setTitle("Air Terjun Geripak ");
        ...
        String url = "http://192.168.43.141/wisata/geripak.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AirTerjunGeripak.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AirTerjunGeripak.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_geripakEmail,Email);
                params.put(konfigurasi.KEY_EMP_geripakKomentar,coment);
                params.put(konfigurasi.KEY_EMP_geripakRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_AIRTERJUNGERIPAK, params);
                return res;
            }
        }

...
public class Kolamaikbukak extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kolamaikbukak);
        this.setTitle("Kolam Aik Bukak");
        ...
        String url = "http://192.168.43.141/wisata/aiqbukak.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(Kolamaikbukak.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(Kolamaikbukak.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_aiqbukakEmail,Email);
                params.put(konfigurasi.KEY_EMP_aiqbukakKomentar,coment);
                params.put(konfigurasi.KEY_EMP_aiqbukaRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_KOLAMRENANGAIQBUKAK, params);
                return res;
            }
        }

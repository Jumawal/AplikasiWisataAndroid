...
public class GunungRinjani extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://192.168.43.141/wisata/rinjani.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(GunungRinjani.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(GunungRinjani.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_rinjaniEmail,Email);
                params.put(konfigurasi.KEY_EMP_rinjaniKomentar,coment);
                params.put(konfigurasi.KEY_EMP_rinjaniRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_GUNUNGRINJANI, params);
                return res;
            }
        }

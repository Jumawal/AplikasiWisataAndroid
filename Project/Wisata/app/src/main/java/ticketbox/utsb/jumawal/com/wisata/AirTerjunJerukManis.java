...
public class AirTerjunJerukManis extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_air_terjun_jeruk_manis);
        this.setTitle("Air Terjun Jeruk Manis ");
        ...
        String url = "http://192.168.43.141/wisata/jerukmanis.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(AirTerjunJerukManis.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(AirTerjunJerukManis.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_jerukmanisEmail,Email);
                params.put(konfigurasi.KEY_EMP_jerukmanisKomentar,coment);
                params.put(konfigurasi.KEY_EMP_jerukmanisRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_AIRTERJUNJERUKMANIS, params);
                return res;
            }
        }

...
public class PantaiLabuanHaji extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantai_labuan_haji);
        this.setTitle("Pantai Labuan Haji");
        ...
        String url = "http://192.168.43.141/wisata/labuanhaji.php";
        view.loadUrl(url);
    ...
    private void addEmployee(){
        ...
        class AddEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PantaiLabuanHaji.this,"Menambahkan...","Tunggu...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                ...
                loading.dismiss();
                Toast.makeText(PantaiLabuanHaji.this,s, Toast.LENGTH_LONG).show();
            }

            @Override
            protected String doInBackground(Void... v) {
                HashMap<String,String> params = new HashMap<>();
                params.put(konfigurasi.KEY_EMP_labuanEmail,Email);
                params.put(konfigurasi.KEY_EMP_labuanKomentar,coment);
                params.put(konfigurasi.KEY_EMP_labuanRating,rating);


                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(konfigurasi.URL_PANTAILABUAN, params);
                return res;
            }
        }
